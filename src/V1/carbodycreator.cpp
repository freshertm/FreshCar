...
#include <QDebug>
#include <QList>
CarBodyCreator::CarBodyCreator(const CarGenome& carGenome, const World * world)
{
    int genomeLength = world->worldProperties()->genomeBodyLength();
    //const int genomeLength = 50;
    double edgeLength = world->worldProperties()->bodyEdgeLength();
