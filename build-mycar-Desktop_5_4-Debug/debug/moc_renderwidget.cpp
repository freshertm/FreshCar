...
QT_MOC_LITERAL(1, 13, 13), // "setDrawGraphs"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7) // "enabled"

    },
    "RenderWidget\0setDrawGraphs\0\0enabled"
};
...
void RenderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setDrawGraphs((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *RenderWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "b2Draw"))
        return static_cast< b2Draw*>(const_cast< RenderWidget*>(this));
